 ...
 */
public class TelaModificarExcluirVisitante extends javax.swing.JFrame {

    /**
     * Creates new form TelaModificarExcluir2
     */
    public TelaModificarExcluirVisitante() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaModificarExcluirVisitante.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaModificarExcluirVisitante().setVisible(true);
            }
        });
    }
