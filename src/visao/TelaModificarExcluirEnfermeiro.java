 ...
 */
public class TelaModificarExcluirEnfermeiro extends javax.swing.JFrame {

    /**
     * Creates new form TelaModificarExcluir2
     */
    public TelaModificarExcluirEnfermeiro() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        String[] n = new String[Main.listaEnfermeiros.size()];
        for(int i = 0; i< Main.listaEnfermeiros.size();i++)
        n[i] = Main.listaEnfermeiros.get(i).getNome();
        ...
        jRadioButtonMod.setText("Modificar Enfermeiro");

        buttonGroup1.add(jRadioButton2);
        jRadioButton2.setText("Excluir Enfermeiro");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaModificarExcluirEnfermeiro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaModificarExcluirEnfermeiro().setVisible(true);
            }
        });
    }
