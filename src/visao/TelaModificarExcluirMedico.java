 ...
 */
public class TelaModificarExcluirMedico extends javax.swing.JFrame {

    /**
     * Creates new form TelaModificarExcluir2
     */
    public TelaModificarExcluirMedico() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        String[] n = new String[Main.listaMedicos.size()];
        for(int i = 0; i< Main.listaMedicos.size();i++)
        n[i] = Main.listaMedicos.get(i).getNome();
        ...
        jRadioButtonMod.setText("Modificar Medico");

        buttonGroup1.add(jRadioButton2);
        jRadioButton2.setText("Excluir Medico");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaModificarExcluirMedico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaModificarExcluirMedico().setVisible(true);
            }
        });
    }
